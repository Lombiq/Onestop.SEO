...
namespace Onestop.Seo.Drivers {
    public class SeoGlobalSettingsPartDriver : ContentPartDriver<SeoGlobalSettingsPart> {
        ...
        protected override void Exporting(SeoGlobalSettingsPart part, ExportContentContext context) {
            ...
            context.Element(partName).SetAttributeValue("ContentCategoriesTitlePattern", part.ContentCategoriesTitlePattern);
            context.Element(partName).SetAttributeValue("ContentPagesTitlePattern", part.ContentPagesTitlePattern);
        ...
        protected override void Importing(SeoGlobalSettingsPart part, ImportContentContext context) {
            ...
            context.ImportAttribute(partName, "ContentCategoriesTitlePattern", value => part.ContentCategoriesTitlePattern = value);
            context.ImportAttribute(partName, "ContentPagesTitlePattern", value => part.ContentPagesTitlePattern = value);
